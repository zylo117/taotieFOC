...
enum Tmc2209CustomExtensionRegister
{
  ...
  ,TMC2209_EXT_PARAM_ENCODER_ZERO = 0x119U  ,TMC2209_EXT_PARAM_START_RPM = 0x11AU
  ,TMC2209_EXT_PARAM_MAX_RPM = 0x11BU
  ,TMC2209_EXT_PARAM_ACCEL_RPM_S = 0x11CU
  ,TMC2209_EXT_PARAM_PULSE_COUNT = 0x11DU
  ,TMC2209_EXT_PARAM_MOTION_MODE = 0x11EU
  ,TMC2209_EXT_PARAM_MOTION_COMMAND = 0x11FU
  ,TMC2209_EXT_PARAM_SPEED_RPM = 0x120U
  ,TMC2209_EXT_PARAM_POSITION_DEG = 0x121U
  ,TMC2209_EXT_PARAM_WAVEFORM_WINDOW_MS = 0x122U
  ,TMC2209_EXT_PARAM_STEP_PULSE_WIDTH_NS = 0x123U
  ,TMC2209_EXT_PARAM_MOTOR_ENABLE = 0x124U
  ,TMC2209_EXT_PARAM_MOTOR_DISABLE = 0x125U
  ,TMC2209_EXT_PARAM_SINGLE_HALF_ROUND_FORWARD_STEPS = 0x126U};
