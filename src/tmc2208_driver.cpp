...
Tmc2208Driver::Tmc2208Driver()
  : enabled_(false), direction_(false), config_{32U, 256U, 0.8f, 0.2f, true, true, 0.110f, 0.0f, 115200U, true, false, TMC2209_UART_GPIO, TMC2209_UART_PIN}
{
}
...
void Tmc2208Driver::sendStepPulse(uint32_t width_ns)
{
